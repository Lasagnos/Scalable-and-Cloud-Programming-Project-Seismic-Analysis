...
gcloud dataproc jobs submit spark \
  ...
  -- gs://<bucket>/<dataset>.csv gs://<bucket>/<outputPath> <num_partizioni>
```
Argomenti Posizionali:
    path_input: Percorso del file CSV del dataset.
    path_output: Percorso della directory di output (verrà creata automaticamente).
    num_partizioni: (Opzionale) Numero di partizioni per il repartitioning (consigliato: 512-1024).
